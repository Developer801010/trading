...
<div class="card mb-0">
    <div class="card-body">
        ...
        <h4 class="card-title mb-1">Choose New Password🔒</h4>
        <p class="card-text mb-2">
            Your new password must be 8 or more characters, at least 1 upper and lowercase letter, 1 number and 1 special character ($#@!%?*-+).\
        </p>
