 ...
 <footer class="lp-footer">
    <div class="container-xl">
        <div class="row gy-3">
            ...
            <div class="col-sm-6 col-md-4 col-lg-6 order-1 order-sm-2 order-md-1">
                <h4>Quick Links</h4>
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link">Trading Strategy</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="col-sm-4 col-md-4 col-lg-3 order-2 order-sm-1 order-md-2">
                <h4>Contact Us</h4>
                <ul class="navbar-nav flex-column">
                    <li>
